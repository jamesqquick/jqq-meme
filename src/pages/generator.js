...
export default function MemeGenerator() {
    ...
    const updateDirections = (direction, increment) => {
        if (direction === 'top' && directions[direction] + increment < 100)
            return;
        if (direction === 'left' && directions[direction] + increment < 40)
            return;
            ...
            <StyledContainer>
                ...
                <StyledForm>
                    ...
                    {user && !isPremium && (
                        <StyledField>
                            <StyledLabel>
                                Upgrade for $1 to download the meme and get
                                access to premium controls!
                            </StyledLabel>
                            <StrongButton
                                type="button"
                    ...
                    {!user && !isPremium && (
                        <StyledField>
                            <StyledLabel>
                                Login and Upgrade for $1 to download the meme
                                and get access to premium controls!
                            </StyledLabel>
                            <LoginButton />
                        </StyledField>
                    )}
